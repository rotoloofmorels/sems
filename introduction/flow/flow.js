...
function Annotation(paper, options) {
  ...
  this.SOLID_COLOR  = "#b4d7fa";
  this.TARGET_COLOR = "#b4d7fa";
  this.BOTTOM       = 266;
...
Annotation.prototype.activate = function() {
  var self = this;
  this.targetOuter.animate({r:14, cy: this.BOTTOM, fill: this.SOLID_COLOR}, 400, mina.elastic);
  this.targetInner.animate({r:10, cy: this.BOTTOM, fill: this.SOLID_COLOR}, 400, mina.elastic);
...
Annotation.prototype.deactivate = function() {
  var self = this;
  this.targetOuter.animate({r:7, cy: this.top + this.height, fill: this.TARGET_COLOR}, 400, mina.elastic);
  this.targetInner.animate({r:5, cy: this.top + this.height, fill: this.TARGET_COLOR}, 400, mina.elastic);
...
Annotation.prototype.scaleTarget = function(factor) {
  this.targetOuter.animate({r:7 * factor}, 400, mina.elastic);
  this.targetInner.animate({r:5 * factor}, 400, mina.elastic);
}
